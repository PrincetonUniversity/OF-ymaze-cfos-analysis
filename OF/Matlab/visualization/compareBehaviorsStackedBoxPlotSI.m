function [] = compareBehaviorsStackedBoxPlotSI(groups,labels,fig_path,out_path,MSortedLabels,M,colors_behaviors)
% COMPAREBEHAVIORSSTACKEDBOXPLOTSI: plot compositional mean fractions to be
...
print(h,[fig_path 'comparison_8_behaviors.pdf'],'-dpdf','-r0');
close(h)
...
%%
print(h,[fig_path 'comparison_8_behaviors_between_days.pdf'],'-dpdf','-r0');
close(h)
