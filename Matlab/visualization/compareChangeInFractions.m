function [] = compareChangeInFractions(groups,labels,fig_path,out_path,MSortedLabels,M,colors)
% COMPARECHANGEINFRACTIONS: compare change in the fractions of time spent in behaviors on day 2 vs
% day 1
%
% Input:
...
writetable(data_exp,[out_path 'Logratio_fraction_in_behavior.txt'])
